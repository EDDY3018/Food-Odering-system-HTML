$(document).ready(function() {
    ...
    $("#thanksMessage, #checkOrderHamburger, #checkOrderMomo, #checkOrderPizza, #checkOrderFries, #checkOrderIndomie, #checkOrderJollof, #finishOrderDialog").hide();
    ...
    $("#addToCartIndomie").on("click", function() {
        $("#checkOrderIndomie").dialog({
            hide: "blind",
            show: "blind",
            width: "400px",
            closeText: "X"
    ...
    $("#addToCartJollof").on("click", function() {
        $("#checkOrderJollof").dialog({
            hide: "blind",
            show: "blind",
            width: "400px",
            closeText: "X"
            ...
            $(".addIngredientWrap > .confirmInput").on("click", function() {
                if ($("#newIngredient").val() != "") {
                    ...
                    for (var i = 0; i < newIngredient.length; i++) {
                        $(this).parent().siblings("ul").append("<li>" + newCheckbox + newIngredient[i] + "  (+GHc3)</li>");
                    }
    ...
    $(".listOver").on("click", function() {
        ...
        var orderPrice = '<h3 class="orderPrice"><span>' + $(this).parent().children(".totalDialog").children("span").text() + '</span>GHc <h3>'
        ...
        $("#listOfOrders").children("li").children(".orderPrice").children("span").each(function() {
            ...
            $(".cart > h3 > span").text(totalOrderPrice + "GHc ");
        });
